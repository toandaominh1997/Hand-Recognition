...
class Learning(object):
    ...
    def _train_epoch(self, data_loader):
        ...
        for idx, sample in enumerate(data_loader):
            ...
            pos_img = sample['pos_img'].to(self.device)
            neg_img = sample['neg_img'].to(self.device)
        
            pos_cls = sample['pos_class'].to(self.device)
    ...
    @staticmethod
    def __convert_to_tensor__(data_dict, device):
